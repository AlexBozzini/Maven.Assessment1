...
public class StringUtils {
    ...
    public static String reverseFirstWord(String sentence) {
        ...
        String reverseFirstWord = builder.reverse().toString();
    ...
    public static String reverseFirstWordThenCamelCase(String sentence) {
        ...
        StringBuilder builder = new StringBuilder(firstWord);
        String reverseFirstWord = builder.reverse().toString();
        String reverseAndCapitalizeFirstWord = Character.toUpperCase(reverseFirstWord.charAt(0)) + reverseFirstWord.substring(1);
        return reverseAndCapitalizeFirstWord;
    }
    ...
    public static String removeCharacterAtIndex(String str, int index) {
        String removedCharacter = str.substring(0, index) + str.substring(index + 1, str.length());
